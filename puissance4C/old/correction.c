...
static void affiche_grille(void) //OK
{
    /*
...
static void calcule_position(int coup, struct position *pos)//OK
{
    /*
...
static int coup_valide(int col)//OK
{
    /*
...
static int demande_action(int *coup)//OK
{
    /*
...
static int grille_complete(void)//OK
{
    /*
...
static void initialise_grille(void)//OK
{
    /*
...
static int position_valide(struct position *pos)//?? USEFULL ?
{
    /*
...
static int statut_jeu(struct position *pos, char jeton)//TO DO
{
    /*
...
static int vider_tampon(FILE *fp)//Normalement ok car validation input
{
    /*
